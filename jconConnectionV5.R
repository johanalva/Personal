...
# Write File --------------------------------------------------------------
write.csv(c2,"C:/Users/johnalva/Box Sync/My Documents/Trello Reports/Analytics 4.csv")
# 
...
# nPlot(cycleTimeDays ~ WeekEnding, group = 'Squad', data = c2, type = 'multiBarChart')
# 
# 
