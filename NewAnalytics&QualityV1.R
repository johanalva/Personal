...
#  ------------------------------------------------------------------------
ck <- cards$idChecklists
ck
as.data.frame(unlist(ck))
...
# Save Files:
ae <- "https://trello.com/b/i4u41Lhr"
setwd("C:/Users/johnalva/Box Sync/My Documents/POOLS/NewSDR/New Analytics")
write.csv(cardsDisplay, "AnalyticsTrello.csv")
write.csv(agile.metrics, "AgileMetrics.csv")
