...
apicaq <- oauth_app("trello", "d00e8afb53f716936477840488ad72f5", "7e46b4cff5903e5c74d88cc26fa262a1b347edacfabe7b95157f6ca52c67aa7f")
aeaq <- "https://trello.com/b/i4u41Lhr/analytics-sdr.json"
rqaq <- "https://trello.com/1/OAuthGetRequestToken"
auaq <- "https://trello.com/1/OAuthAuthorizeToken"
acaq <- "https://trello.com/1/OAuthGetAccessToken"
otepaq <- oauth_endpoint(rqaq, auaq, acaq, aeaq)

my_token <- oauth1.0_token(otepaq, apicaq)

req <- httr::GET(aeaq, my_token, paging = TRUE)
json <- httr::content(req, paging = TRUE)
#class(json) # Return a list.
ibd <- get_id_board(aeaq, my_token)
